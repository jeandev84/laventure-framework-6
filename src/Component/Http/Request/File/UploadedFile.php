...
use Laventure\Component\Http\Request\File\Exception\UploadedFileException;
...
class UploadedFile extends File implements UploadedFileInterface
{
    ...
    */
    ...
    {
          if (! $filename) {
              $filename  = sha1(mt_rand()). ".". $this->getExtension();
          }

          $uploadedFilePath = rtrim($targetPath, DIRECTORY_SEPARATOR). DIRECTORY_SEPARATOR. $filename;
